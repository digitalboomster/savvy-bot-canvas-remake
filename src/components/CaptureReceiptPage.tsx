...
const CaptureReceiptPage: React.FC<CaptureReceiptPageProps> = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-neutral-100">
      {/* Header */}
      <div className="w-full max-w-md flex items-center justify-between px-1 py-4 mb-5">
        <button
          onClick={onBack}
      ...
      {/* Main Camera and Frame */}
      <div
        className="relative rounded-[22px] flex items-center justify-center overflow-visible"
        style={{
          width: FRAME_WIDTH,
          height: FRAME_HEIGHT,
          background: "#111",
