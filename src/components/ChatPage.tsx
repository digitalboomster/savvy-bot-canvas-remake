  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white flex flex-col">
      ...
      <div className="flex items-center justify-between p-4 border-b border-white/10">
        ...
        >
          <ArrowLeft size={24} className="text-gray-300 hover:text-white" />
        </button>
          ...
          <div className="grid grid-cols-2 gap-3">
            {starterPrompts.map((prompt, index) => (
              <button
                ...
                className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 text-left hover:bg-white/10 transition-all duration-200 text-sm"
              >
                {prompt}
              </button>
            ))}
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`p-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full hover:bg-white/10 transition-all duration-200 ${
          ...
          {/* Input Field */}
          <div className="flex-1 flex items-center bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-2">
            <input
              type="text"
              value={inputText}
            ...
            >
              <Mic size={20} className="text-gray-300 hover:text-white" />
            </button>
          </div>
        </div>
      </div>
